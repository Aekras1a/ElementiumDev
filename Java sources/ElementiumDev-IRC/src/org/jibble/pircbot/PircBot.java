...
public abstract class PircBot implements ReplyConstants {    
    ...
    /**
     * Returns whether or not the PircBot is currently in a channel.
     * The result of this method should only act as a rough guide,
     * as the result may not be valid by the time you act upon it.
     *
     * @return True if and only if the PircBot is currently in a channel.
     */
    public final synchronized boolean isInChannel() {
        return channel != null;
    }
    ...
    private String _name = "ELEMENTIUMDEV";
    private String _nick = _name;
    private String _login = "ElementiumDev";
    private String _version = "IRC Remote Controller";
